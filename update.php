...
$updateResult = $empcollection ->updateOne (['nombre'->$field_name,'dni'->$field_dni,'direccion'->$field_direccion,'email'->$field_email,'sexo'->$field_sexo,'estudios'->$field_estudios,'interes'->$field_interes,'dia'->$field_dia]);
